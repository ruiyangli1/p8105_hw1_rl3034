...
What happens in the above code chunk is that we can convert the logical variable and the factor variable to the numerical vector using the `as.numeric` function, but we fail to do so for the character variable. 
